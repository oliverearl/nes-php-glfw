# Claude Development Guidelines for NES Emulator
...
- Keep this document and all other agentic development documents in sync with `AGENTS.md`, including `.cursorrules`, `.github/copilot-instructions.md`, and `.junie/guidelines.md`.
